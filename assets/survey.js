...
const IPA_ITEMS = [
  ...
  { id: 34, area: '영역 B. AI·정보 내용 지식', text: '컴퓨팅 사고력(분해·패턴인식·추상화·알고리즘 등) 개념 이해 및 지도' },
  { id: 35, area: '영역 B. AI·정보 내용 지식', text: '알고리즘과 프로그래밍(순차·반복·조건 등) 기초 이해 및 지도' },
  ...
  { id: 39, area: '영역 C. 정보교육 수업 운영 역량', text: '블록 기반 프로그래밍(엔트리·스크래치 등) 수업 설계 및 운영' },
  { id: 40, area: '영역 C. 정보교육 수업 운영 역량', text: '피지컬 컴퓨팅·로봇(마이크로비트·교육용 로봇 등) 활용 수업 운영' },
  { id: 41, area: '영역 C. 정보교육 수업 운영 역량', text: 'AI 교구·플랫폼(Teachable Machine·엔트리 AI 등) 활용 수업 운영' },
